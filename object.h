...
public:
    ...
    // Ben�tigter Speicher wird in dieser Fkt. allokiert
    // rgb: Farbe
    // x,y,z: Position
    ...
    void
    setMaterial(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha, GLfloat spec, GLfloat shine, GLfloat emis);
...
private:
    ...
    bool clustertexcoords;                // File enth�lt Clustervertices mit Texturkoordinatenindex
    bool clusternormals;                // File enth�lt Clustervertices mit Normalenindex
    ...
    GLfloat *f_normals;                    // Liste der berechneten Fl�chennormalen
    GLfloat *p_normals;                    // Liste der berechneten Vertexnormalen (nur wenn clusternormals == false)

    int *tris;                        // Liste der Dreieck (Index)
    int *i_normals;                    // Liste der importierten Vertexnormalen f�r die Dreieckspunkte (Index)
    int *i_texcoords;                    // Liste der importierten Texturkoordinaten f�r die Dreieckspunkte (Index)
